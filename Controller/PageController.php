...
use BRS\CoreBundle\Entity\Page;
...
class PageController extends AdminController
{
	...
	protected function setup()
	{
		...
		$this->setRouteName('brs_admin_page');
		$this->setEntityName('BRSCoreBundle:Page');
...
*/		
		...
		$edit_widget->setSuccessRoute('brs_admin_page_edit');
